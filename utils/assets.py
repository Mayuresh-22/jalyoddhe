...
# ==================== Geographic Region of Interest Mapping ====================
...
# ==================== Sentinel-2 Band and Feature Mappings ====================
...
rf_features = [
    'nm440', 'nm490', 'nm560', 'nm665', 'nm705', 'nm740', 'nm783', 'nm842',
...
def map_category_to_id(category_name):
    """Map a category name to its corresponding ID."""
    return category_mapping[category_name]


vectorized_category_mapper = np.vectorize(map_category_to_id)