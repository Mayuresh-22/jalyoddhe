...
const Footer = () => {
  return (
    <footer className="w-full h-[8vh] bg-white/10 backdrop-blur-xl border-t border-white/20 shadow-[0_-4px_20px_rgba(0,0,0,0.15)] flex items-center justify-center mt-4">
